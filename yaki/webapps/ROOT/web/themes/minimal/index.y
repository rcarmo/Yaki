...
<div id="page">
    ...
    <h1 id="site-title"><a href="/space/HomePage"><%=self.Request.getParameter('site_name', 'Yaki Wiki Engine')%></a></h1>
...
for i in links:
  if i[0] == self.Request.getParameter('path', 'meta/EmptyPage'):
    ...
    css = "page_item"
  self.write( '<li class="%s"><a href="/space/%s" title="%s">%s</a></li>' % (css, i[0], i[1], i[2]))  
%>
	</ul>
</div>
	</div>
...
<div class="wrapper">
  ...
  <hr />
  <div class="secondary">
<form method="get" action="/space/meta/Search" method="get">
